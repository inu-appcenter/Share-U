...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        item[0]=new SuperiorLecture(R.drawable.excel,"#1");
        item[1]=new SuperiorLecture(R.drawable.excel,"#2");
        item[2]=new SuperiorLecture(R.drawable.excel,"#3");
        item[3]=new SuperiorLecture(R.drawable.excel,"#4");
        item[4]=new SuperiorLecture(R.drawable.excel,"#5");
